...
<svg width="100%" height="auto"
 viewBox="0.00 0.00 633.39 188.00" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<g id="graph0" class="graph" transform="scale(1 1) rotate(0) translate(4 184)">
<title>G</title>
<polygon fill="#ffffff" stroke="transparent" points="-4,4 -4,-184 629.3927,-184 629.3927,4 -4,4"/>
<!-- Programming1 -->
<g id="node1" class="node">
<title>Programming1</title>
<ellipse fill="none" stroke="#000000" cx="446.3107" cy="-162" rx="64.2862" ry="18"/>
<text text-anchor="middle" x="446.3107" y="-157.8" font-family="Times,serif" font-size="14.00" fill="#000000">Programming</text>
</g>
<!-- Library Writing -->
<g id="node2" class="node">
<title>Library Writing</title>
<ellipse fill="none" stroke="#000000" cx="356.3107" cy="-90" rx="72.3901" ry="18"/>
<text text-anchor="middle" x="356.3107" y="-85.8" font-family="Times,serif" font-size="14.00" fill="#000000">Library Writing</text>
</g>
<!-- Programming1&#45;&gt;Library Writing -->
<g id="edge1" class="edge">
<title>Programming1&#45;&gt;Library Writing</title>
<path fill="none" stroke="#000000" d="M424.9819,-144.937C413.2984,-135.5902 398.6388,-123.8625 385.8677,-113.6456"/>
<polygon fill="#000000" stroke="#000000" points="387.7934,-110.704 377.7982,-107.19 383.4205,-116.1701 387.7934,-110.704"/>
</g>
<!-- Application Writing -->
<g id="node3" class="node">
<title>Application Writing</title>
<ellipse fill="none" stroke="#000000" cx="536.3107" cy="-90" rx="89.1641" ry="18"/>
<text text-anchor="middle" x="536.3107" y="-85.8" font-family="Times,serif" font-size="14.00" fill="#000000">Application Writing</text>
</g>
<!-- Programming1&#45;&gt;Application Writing -->
<g id="edge2" class="edge">
<title>Programming1&#45;&gt;Application Writing</title>
<path fill="none" stroke="#000000" d="M467.6394,-144.937C479.1524,-135.7266 493.5552,-124.2044 506.1931,-114.094"/>
<polygon fill="#000000" stroke="#000000" points="508.5729,-116.6725 514.1952,-107.6924 504.2,-111.2064 508.5729,-116.6725"/>
</g>
<!-- Conversation with Machine -->
<g id="node4" class="node">
<title>Conversation with Machine</title>
<ellipse fill="none" stroke="#000000" cx="118.3107" cy="-18" rx="118.1217" ry="18"/>
<text text-anchor="middle" x="118.3107" y="-13.8" font-family="Times,serif" font-size="14.00" fill="#000000">Conversation with Machine</text>
</g>
<!-- Library Writing&#45;&gt;Conversation with Machine -->
<g id="edge3" class="edge">
<title>Library Writing&#45;&gt;Conversation with Machine</title>
<path fill="none" stroke="#000000" d="M310.1397,-76.0323C273.5492,-64.9629 222.0319,-49.3779 181.5977,-37.1457"/>
<polygon fill="#000000" stroke="#000000" points="182.4217,-33.7383 171.8366,-34.1927 180.3948,-40.4385 182.4217,-33.7383"/>
</g>
<!-- Conversation with Human -->
<g id="node5" class="node">
<title>Conversation with Human</title>
<ellipse fill="none" stroke="#000000" cx="367.3107" cy="-18" rx="112.906" ry="18"/>
<text text-anchor="middle" x="367.3107" y="-13.8" font-family="Times,serif" font-size="14.00" fill="#000000">Conversation with Human</text>
</g>
<!-- Library Writing&#45;&gt;Conversation with Human -->
<g id="edge4" class="edge">
<title>Library Writing&#45;&gt;Conversation with Human</title>
<path fill="none" stroke="#000000" d="M359.0864,-71.8314C360.2629,-64.131 361.6618,-54.9743 362.9692,-46.4166"/>
<polygon fill="#000000" stroke="#000000" points="366.4471,-46.8272 364.4975,-36.4133 359.5273,-45.7699 366.4471,-46.8272"/>
</g>
<!-- phantom -->
<g id="node6" class="node">
<title>phantom</title>
<ellipse fill="none" stroke="#000000" stroke-width="0" cx="536.3107" cy="-18" rx="27" ry="18"/>
<text text-anchor="middle" x="536.3107" y="-13.8" font-family="Times,serif" font-size="14.00" fill="#000000">...</text>
</g>
<!-- Application Writing&#45;&gt;phantom -->
<g id="edge5" class="edge">
<title>Application Writing&#45;&gt;phantom</title>
<path fill="none" stroke="#000000" stroke-dasharray="5,2" d="M536.3107,-71.8314C536.3107,-64.131 536.3107,-54.9743 536.3107,-46.4166"/>
<polygon fill="#000000" stroke="#000000" points="539.8108,-46.4132 536.3107,-36.4133 532.8108,-46.4133 539.8108,-46.4132"/>
</g>
</g>
</svg>
</div>
...
For example, consider the [grpc](https://godoc.org/google.golang.org/grpc) library. It does one thing - gRPC. But gRPC has many sub-components to it - server and client are the two primary sub-components.
...
I would go so far to prefer only libraries that have been tested using property-based testing (I had previously written [an article about property-based testing on GopherAcademy](https://blog.gopheracademy.com/advent-2017/property-based-testing/)) or have been fuzz-tested.
...
Having said that, if you develop driver libraries, it might be a bit difficult to test such libraries. There are some [advances in source fuzzing](https://www.youtube.com/watch?v=xzG0pLM4Q64) for driver libraries, but I have found no good general-purpose testing patterns in the case of driver libraries that works well for my workflow.
...
This happens in Go as is. The following graph shows packages that are composable with one another in my GOPATH. The source code of how this graph is generated can be found in [this gist](https://gist.github.com/chewxy/2d286df6f2ac8910f69e7df9257b3944).
